...
module.exports.list = async (req, res) => {
    res.send(await PeriodoExperiencia.findAll({...query.removeTimestamp(), where: {idEmpresa: req.authData.empresa}}))
}
...
module.exports.save = async (req, res) => {
    try {
        const result = await PeriodoExperiencia.create(addIdEmpresa(req.body, req.authData.empresa))
        res.send(result)
    } catch (e) {
